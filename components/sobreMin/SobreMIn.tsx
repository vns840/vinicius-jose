    ...
    <section className="bg-purple01 text-white max-md:h-auto" id="sobre">
      ...
      <div className="flex justify-center items-center gap-8 max-md:flex-col max-md:p-7 max-md:text-center">
        <div>
          ...
          <p className="w-96 leading-8 max-md:w-72">Apaixonado por tecnologia desde sempre, desde de 2019 venho desempenhando a função de analista de suporte. Atualmente venho fazendo a transição para área de desenvolvimento Front-end atualmente estudando  e trabalhando muito HTML,  CSS,  Javascript e Reactjs.</p>
        </div>
